import{_ as n,o as e,c as t,a as s,b as l,t as p,d as o}from"./app.4ad49d17.js";const c="/assets/0217-1.0f96e32f.png",f=JSON.parse('{"title":"VitePress如何添加百度统计","description":"","frontmatter":{"title":"VitePress如何添加百度统计"},"headers":[],"relativePath":"page/state/page0217.md","lastUpdated":1676599471000}'),r={name:"page/state/page0217.md"},i={id:"frontmatter-title",tabindex:"-1"},D=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),d=o(`<h1 id="在config-js中添加head属性" tabindex="-1">在config.js中添加<code>head</code>属性 <a class="header-anchor" href="#在config-js中添加head属性" aria-hidden="true">#</a></h1><pre><code>官方文档
